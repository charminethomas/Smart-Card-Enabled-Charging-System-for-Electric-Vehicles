...
#define RFID_RX_PIN 2  // Connect the RFID's TX pin to NodeMCU's GPIO2 (D2)
#define RFID_TX_PIN 3  // Connect the RFID's RX pin to NodeMCU's GPIO3 (D3)

SoftwareSerial RFID(RFID_RX_PIN, RFID_TX_PIN); // Create a software serial object

const char* ssid = "Thomas"; // Replace with your Wi-Fi SSID
const char* password = "Rowan071"; // Replace with your Wi-Fi password
